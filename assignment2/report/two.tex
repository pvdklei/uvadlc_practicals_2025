...
I have trained the LLM for 5 epochs on the "Fairy Tales by Brothers Grimm".

Here is the training loss curve from tensorboard:

\begin{center}
    \includegraphics[width=0.8\textwidth]{imgs/2.7_loss.png}
\end{center}

And here is the training accuracy curve from tensorboard:

\begin{center}
    \includegraphics[width=0.8\textwidth]{imgs/2.7_accuracy.png}
\end{center}
